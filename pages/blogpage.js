  ...
  return (
    <>
      ...
      <main className="relative">
        ...
        <div className="header--logo w-[145px]"><img className='w-full' src="../tittablue.png" alt="" /></div>
        {
        ...
        <article className="blogs grid grid-cols-1 gap-y-14">
          <div className="blog-post w-full rounded-xl bg-white shadow-2xl pb-6">
            <div className="img relative w-full">
              <img src="../post-img.jpg" className="w-full object-fill rounded-t-xl" alt="" />
              <div className="pills absolute -bottom-5 flex gap-2 text-sm left-0">
                <div className="pill py-2 px-4 text-white bg-[#1367fe] rounded">Latest Posts</div>
                <div className="pill py-2 px-4 text-white bg-[#1367fe] rounded">Start Up</div>
              </div>  
            </div>
            <div className="contz flex flex-col gap-y-1">
              <div className="pt-10 px-4 font-semibold text-[#000] text-2xl poppins">Be Yourself, Everyone Else is Already Taken.</div>
              {/* <div className="author"></div> */}
              <div className="details flex w-full justify-between px-4 text-sm text-[#696969] mb-2">
                <div className="date flex gap-2">
                  <span className="cal-icon"><img src="../calendar.png" alt="" /></span>
                  November 20, 2020
                </div>
                <div className="comments flex gap-2">
                  <span className="comment-icon"><img src="../comment.png" alt="" /></span>
                  <span>0</span> Comments
                </div>
              </div>
              <div className="bodyd text-[#696969] px-4 text-base">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi iure ratione necessitatibus molestias, quam, a unde minima amet nostrum, delectus suscipit ab repellendus ea ut pariatur mollitia nesciunt!
              </div>
              <div className="text-white text-base  bg-linear font-bold w-[140px] text-center mt-8 mx-4">Read More</div>
            </div>
          </div>
          <div className="blog-post w-full rounded-xl bg-white shadow-2xl pb-6">
            <div className="img relative w-full">

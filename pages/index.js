...
const Home = () => {
  ...
  return (
    ...
    <section className='hero z-10 text-white w-[100vw] h-[110vh] relative  banner 2xl:h-[80vh]'>
      ...
      }} animate={{y: ["100%", "-100%"]}} className="particle1 w-[2px] md:w-[5px] absolute top-[18rem] -z-10 md:top-[22rem] left-[1rem] md:left-[5rem]"><img src="../particle.png" alt="" /></motion.div>
      <motion.div
        transition={{
          y: {
          duration: 1.8,
        ...
        className="particle3 absolute top-[24rem] -z-10 w-[2px] md:w-[5px] md:top-[32rem] right-[4rem] md:right-[67rem]"><img src="../particle.png" alt="" /></motion.div>
      <motion.div
        transition={{
          y: {
          duration: 1.8,
        ...
        className="particle4 absolute w-[2px] md:w-[5px] top-[6rem] md:top-[22rem] -z-10 right-[3rem] md:right-[19rem]"><img src="../particle.png" alt="" /></motion.div>
      <div className="hero-content w-full flex flex-col items-center sm:flex-row sm:justify-between sm:items-center mx-auto md:max-w-6xl  gap-y-12 px-4 md:px-0">
        <div className="sm:pl-4 left-content h-full w-full mt-[6.2rem] sm:mt-[7.5rem] md:mt-[9rem] justify-center md:gap-y-5 flex flex-col items-center sm:items-start sm:text-left text-center gap-4 sm:mr-6">
          <div className="font-heading1 ">Technology & Software Development</div>
          <div className="font-heading2 sm:leading-relaxed xl:text-[3rem]">Offering Smart IT And Software Solutions</div>
          <div className="font-body sm:text-left xl:text-base xl:leading-relaxed">Ever since 2019, when an unknown is simply dummy text the printing. Lorem ipsum dolor, sit amet.</div>
          <div className="btn-grp flex items-center gap-4">
            <button className='text-white text-base  bg-linear font-bold '>Get Started</button>
            <button className='bg-white text-base font-bold bg-outline'>How we work</button>
          </div>
        ...
        <div className="banner-person-animation relative max-w-[22rem] sm:max-w-md sm:mr-6 md:max-w-lg  sm:self-center w-full md:-mt-[19rem] sm:-mt-40">
          <div className="w-full absolute top-0 z-20"><img src="../banner-person1.png" className='w-full' alt="banner person" /></div>
          <motion.div
            initial={{rotate:0}}
            animate={{
              rotate: 360
            ...
            className="bannerblob1 absolute top-0 z-10 w-full"><img  className='w-full' src="../banner-blob-orange.png" alt="" /></motion.div>
          <motion.div
            initial={{rotate: 0}}
            animate={{
              rotate:360
            ...
            transition={{duration: 6, repeat: Infinity, repeatDelay: 0}}
            className="bannerblob2 absolute top-0 z-0 w-full"><img className='w-full' src="../banner-blob-blue.png" alt="" /></motion.div>
        </div>
      </div>
    </section>
    <section className="background-overlay-2 pt-28 pb-16 mx-auto w-full flex flex-col relative items-center gap-y-5 text-center px-4 ">
      ...
      <h3 className="font-heading1 text-[#104cba] poppins font-semibold">Featured Services</h3>
      <div className="poppins text-4xl md:text-4xl leading-relaxed font-semibold">Engaging Creative Minds Via Technology</div>
      <div className="cards  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 place-items-center mt-5 md:max-w-6xl">
        <div className="card px-4 max-w-md bg-white w-full pt-8 pb-12 rounded shadow-2xl">
          ...
          <div className="font-semibold poppins md:text-xl   text-[#010101] text-lg mt-6 ">Creative Idea</div>
          <div className="mt-2 text-sm md:text-base text-[#696969] max-w-xs leading-relaxed">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Itaque, quae.</div>
        </div>
        <div className="card px-4 max-w-md bg-white w-full pt-8 pb-12 rounded shadow-2xl">
          <div className="">
          <img src="../illustration2.jpg" alt="" />
          </div>
          <div className="font-semibold poppins md:text-xl  text-[#010101] text-lg mt-6 ">Successful Project</div>
          <div className="mt-2 text-sm md:text-base text-[#696969] max-w-xs leading-relaxed">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Itaque, quae.</div>
        </div>
        <div className="card px-4 max-w-md bg-white w-full pt-8 pb-12 rounded shadow-2xl">
          <div className="">
          ...
          <div className="font-semibold poppins md:text-xl  text-[#010101] text-lg mt-6 ">Time Management</div>
          <div className="mt-2 text-sm md:text-base text-[#696969] max-w-xs leading-relaxed">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Itaque, quae.</div>
        </div>
    ...
    <section className='promo w-full md:max-w-6xl mx-auto md:rounded md:relative md:-bottom-[5.5rem] shadow-xl'>
      <div className="cont px-4 py-14 md:flex md:items-center">
        <div className="left-content text-center md:text-left md:w-[75%] md:ml-12">
          <div className="poppins font-semibold text-4xl leading-relaxed ">Let's Start A Cool Project With TITTA!</div>
          <div className="mt-2">We Provide Best Solution For Your Business</div>
        </div>
        <div className="right-content mt-3 md:mt-0 text-center w-full md:w-[25%]">
        <div className="btn text-white text-lg mt-6 bg-linear font-bold w-[180px] mx-auto">Start a Project</div>
        </div>
      </div>
    </section>
    ...
    <section className='bg-another pt-32 md:pt-64 pb-24 text-white md:flex md:justify-center md:gap-x-6 w-full'>
      <div className="stuff w-full px-4 md:max-w-6xl md:px-0 md:grid md:grid-cols-2  md:place-items-center">
        <div className="left-content text-center flex flex-col  sm:flex-row  px-4 sm:gap-x-5 gap-y-7">
          <div className="cards1 flex flex-col gap-7 sm:mt-4">
            <div className="card py-6 flex flex-col items-center gap-y-3 bg-another-cards rounded">
              <div className="icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><path fill="#ffffff" d="M16.006 16h-3.506c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h3.506c1.651 0 2.994-1.343 2.994-2.994s-1.343-2.994-2.994-2.994c-0.352 0-0.696 0.060-1.023 0.179-0.218 0.079-0.462-0.002-0.589-0.196s-0.104-0.45 0.056-0.618c0.355-0.373 0.55-0.862 0.55-1.377 0-1.103-0.897-2-2-2-0.642 0-1.229 0.297-1.61 0.814-0.229 0.31-0.362 0.677-0.386 1.061-0.013 0.212-0.159 0.393-0.364 0.451s-0.423-0.021-0.545-0.195l-0.005-0.007c-0.107-0.152-0.226-0.302-0.351-0.442-0.949-1.068-2.312-1.681-3.74-1.681-2.757 0-5 2.243-5 5s2.243 5 5 5h2.5c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5h-2.5c-3.308 0-6-2.692-6-6s2.692-6 6-6c1.603 0 3.137 0.643 4.261 1.775 0.087-0.195 0.196-0.381 0.324-0.555 0.564-0.764 1.467-1.22 2.415-1.22 1.654 0 3 1.346 3 3 0 0.351-0.061 0.694-0.176 1.017 0.061-0.003 0.122-0.004 0.183-0.004 2.202 0 3.994 1.792 3.994 3.994s-1.792 3.994-3.994 3.994z"></path><path fill="#ffffff" d="M12.854 12.146l-2-2c-0.195-0.195-0.512-0.195-0.707 0l-2 2c-0.195 0.195-0.195 0.512 0 0.707s0.512 0.195 0.707 0l1.146-1.146v3.793c0 0.276 0.224 0.5 0.5 0.5s0.5-0.224 0.5-0.5v-3.793l1.146 1.146c0.098 0.098 0.226 0.146 0.354 0.146s0.256-0.049 0.354-0.146c0.195-0.195 0.195-0.512 0-0.707z"></path></svg>
              </div>
              <div className="poppins text-lg mt-2">Innovative Ideas</div>
              <div className="text-[#a1a1a1]">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laudantium?</div>
            </div>
            <div className="card py-6 flex flex-col items-center gap-y-3 bg-another-cards">
              <div className="icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 20 20"><path fill="" d="M17.5 20h-16c-0.827 0-1.5-0.673-1.5-1.5v-16c0-0.827 0.673-1.5 1.5-1.5h16c0.827 0 1.5 0.673 1.5 1.5v16c0 0.827-0.673 1.5-1.5 1.5zM1.5 2c-0.276 0-0.5 0.224-0.5 0.5v16c0 0.276 0.224 0.5 0.5 0.5h16c0.276 0 0.5-0.224 0.5-0.5v-16c0-0.276-0.224-0.5-0.5-0.5h-16z"></path><path fill="" d="M6.5 17h-2c-0.276 0-0.5-0.224-0.5-0.5v-9c0-0.276 0.224-0.5 0.5-0.5h2c0.276 0 0.5 0.224 0.5 0.5v9c0 0.276-0.224 0.5-0.5 0.5zM5 16h1v-8h-1v8z"></path><path fill="" d="M10.5 17h-2c-0.276 0-0.5-0.224-0.5-0.5v-12c0-0.276 0.224-0.5 0.5-0.5h2c0.276 0 0.5 0.224 0.5 0.5v12c0 0.276-0.224 0.5-0.5 0.5zM9 16h1v-11h-1v11z"></path><path fill="" d="M14.5 17h-2c-0.276 0-0.5-0.224-0.5-0.5v-5c0-0.276 0.224-0.5 0.5-0.5h2c0.276 0 0.5 0.224 0.5 0.5v5c0 0.276-0.224 0.5-0.5 0.5zM13 16h1v-4h-1v4z"></path></svg>
              </div>
        ...
        <div className="font-heading1 text-[#104cba] poppins font-semibold">Featured Services</div>
        ...
        <div className="grp flex flex-col gap-y-10">
          <div className="single1 md:flex md:w-full">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="41" viewBox="0 0 56 41" fill="none"><path d="M3 19L20.5 36L52.5 3" stroke="url(#paint3_linear)" stroke-width="7"></path><defs><linearGradient id="paint3_linear" x1="7" y1="41" x2="59" y2="3" gradientUnits="userSpaceOnUse"><stop stop-color="#FF3834"></stop><stop offset="0.905999" stop-color="#FF7133"></stop></linearGradient></defs></svg>
            </div>
            <div className="right-content mt-2 md:mt-0 ml-auto" >
              <div className="title font-semibold poppins">Set Everything Up In Minutes</div>
              <div className="title text-[#a1a1a1] mt-4">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ex nesciunt ipsam placeat voluptatibus distinctio illum.</div>
            </div>
          </div>
          <div className="single2 md:flex md:w-full">
            ...
            <div className="right-content mt-2 md:mt-0">
              <div className="title poppins font-semibold">A Seamless UI Experience</div>
              <div className="title text-[#a1a1a1] mt-4">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ex nesciunt ipsam placeat voluptatibus distinctio illum.</div>
            </div>
          </div>
          <div className="btn text-white text-lg bg-linear font-bold w-[180px]">Discover More</div>
        </div>
        </div>
      </div>
    </section>
...
{/* <img width="211" height="113" src="https://softek.radiantthemes.com/wp-content/uploads/2021/07/16-7.png" class="attachment-full size-full" alt="cloud1" loading="lazy" data-no-retina=""> </div> */}
     {/* cloud2
     <div class="elementor-widget-container">
<img width="201" height="129" src="https://softek.radiantthemes.com/wp-content/uploads/2021/07/15-7.png" class="attachment-full size-full" alt="" loading="lazy" data-no-retina=""> </div>        */}
    ...
    <section className='tech-sol-section pt-32 pb-20 md:pb-24 w-full relative'>
      ...
      <div className="content w-full mx-auto text-center px-4 flex flex-col items-center">
        <div className="font-heading1 text-[#104cba] poppins font-semibold">Technology Solutions</div>
        <div className="poppins text-4xl md:text-4xl leading-relaxed font-semibold my-4 md:my-6">We Provide Software & IT Solutions</div>
        <div className="text-[#696969] mb-24 md:max-w-3xl leading-relaxed mx-auto">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio quasi nam ipsum placeat at incidunt, adipisci laborum sapiente vero corrupti repellendus deleniti veniam.
        </div>
        <div className="illustration relative ">
          <div className="">
            <div className="cloud1 absolute -top-24 md:-top-38 left-0 md:-left-48 z-0"><img src="../cloud1.png" alt="" /></div>
            <div className="dot-red absolute top-2 md:top-[24rem] md:z-0 left-0 md:left-[-9.5rem] -z-10"><img src="../dot-red.png" alt="" /></div>
            <div className="dot-black absolute top-24 md:top-[23.5rem] right-2 md:right-[-13.5rem] z-0"><img src="../dot-black.png" alt="" /></div>
            <div className="cloud2 absolute -top-8 md:top-[-3.1rem] right-2 md:right-[-13.5rem] md:z-0 -z-10"><img src="../cloud2.png" alt="" /></div>
          </div>
          <div className="illus-img relative">
          <img src="../illustationNew.png" alt="illustration" width="732" height="500"/>
          </div>
        </div>
    ...
    <section className='px-4 w-full mx-auto md:max-w-6xl pb-10 md:flex md:items-center md:justify-center md:gap-x-6'>
      <div className="left-content">
        <div className=""><img src="../idea.png" alt="" /></div>
      </div>
      <div className="right-content mt-4">
        <div className="font-heading1 text-[#104cba] poppins font-semibold ">Corporate Ideas</div>
        <div className="poppins text-[#000000] text-4xl md:text-4xl leading-relaxed font-semibold my-6">Perfect Technology Solution For All Medium Business</div>
        <div className="text-[#696969]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis magni quae qui voluptate sit aspernatur et.</div>
        <div className="progresses mt-6 flex gap-y-6 flex-col">
          <div className="progress w-full ">
            <div className="flex justify-between">
              <div className="text-[#696969] font-semibold mb-1">Business Goal</div>
          ...
          <div className="progress w-full">
            <div className="flex justify-between">
              <div className="text-[#696969] font-semibold mb-1">Traffic Growth</div>
          ...
          <div className="progress w-full">
            <div className="flex justify-between">
              <div className="text-[#696969] font-semibold mb-1">Competitor Research</div>
    ...
    <section className='consultancy w-full  text-center px-4'>
      <div className="md:max-w-6xl relative  mx-auto w-full">
        <div className="absolute z-10 top-28 right-6 md:top-[-1.1rem] md:right-[14rem]"><img src="../upsidedowntriangle.svg" alt="" /></div>
        <div className="absolute z-10 top-5 left-[23.95rem]"><img src="../particle2.png" alt="" /></div>
        <div className="absolute z-10 bottom-6 right-32"><img src="../particleyellow.png" alt="" /></div>
        <div className="absolute z-10 -bottom-12 left-[25.5rem]"><img src="../triangle.png" alt="" /></div>
        <div className="absolute hidden md:block z-10 top-8 left-28"><img src="../person1.png" alt="" /></div>
        <div className="absolute hidden md:block z-10 top-2 right-24"><img src="../person2.png" alt="" /></div>
        <div className="absolute hidden md:block z-10 top-40 left-0"><img src="../person3.png" alt="" /></div>
        <div className="absolute hidden md:block z-10 -bottom-20 left-52"><img src="../person4.png" alt="" /></div>
        <div className="absolute hidden md:block z-10 -bottom-20 right-44"><img src="../person5.png" alt="" /></div>
        <div className="absolute hidden md:block z-10 top-40 right-10"><img src="../person6.png" alt="" /></div>
        <div className="font-heading1 text-[#104cba] poppins font-semibold ">Connect With Us</div>
          ...
          <span className="text-[#fd4219] text-4xl md:text-4xl leading-relaxed font-semibold poppins sm:block sm:mt-4">Start Working With Us</span>
          </div>
        <div className="btn text-white text-lg mt-6 bg-linear font-bold w-[11rem] mx-auto">Start a Project</div>
    ...
    <footer className='footer pt-32 px-4 w-full'>
      <div className=" grid grid-cols-1 sm:grid-cols-2 mx-auto lg:justify-items-between lg:items-start lg:grid-cols-4 lg:pt-28 gap-x-6 sm:max-w-6xl gap-y-14">
        <div className="stuffz  flex flex-col gap-y-1 ">
          <div className="font-semibold text-[17px] poppins  mb-8">Quick Links</div>
        ...
        <div className="flex flex-col gap-y-1 ">
          <div className="font-semibold text-[17px] poppins  mb-8">Company</div>
        ...
        <div className="flex flex-col gap-y-1 ">
          <div className="font-semibold text-[17px] poppins  mb-8">Contact Us</div>
        ...
        <div className="flex flex-col gap-y-1 ">
          <div className="font-semibold text-[17px] poppins  mb-8">Subscribe Newsletter</div>
          <div className="max-w-[18rem]">Follow our newsletter to stay updated about us</div>
          <div className="flex subemail mt-2 w-full h-full rounded overflow-hidden">
            <input type="text" className='px-7 py-4 w-[82%]' placeholder='Email Address'/>
            <div className="bttn border-0 object-contain w-[18%]">
              <img src="../sub-button.png" alt="" className='h-full w-full'/>
            </div>
          </div>
          <div className="socialmedialinks mt-8 flex w-full items-center gap-x-6">
            <div className="fb w-[32px]"><img src="../facebook.png" className='w-full' alt="" /></div>
            <div className="twitter w-[32px]"><img src="../twitter.png" className='w-full' alt="" /></div>
            <div className="instagram w-[32px]"><img src="instagram.png" className='w-full' alt="" /></div>
          </div>
        </div>

      </div>
    <section className="sm:max-w-6xl mx-auto cprght border-t-[#515dbb] border-t mt-24 py-6 text-center  text-[#a7b4df] text-sm">2022 TITTA. All Rights Reserved.</section>
    </footer>
  </main>
  </>   
  )

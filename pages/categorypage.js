    ...
    <>
      ...
      <motion.nav
        ...
        <section className="pt-36 px-4">
          <div className="poppins text-5xl text-[#363636]  relative z-10 leading-tight opacity-75">Categories Archives: <span className="rgba">Web Design</span></div>
        </section>
        <section className="pt-12 flex flex-col gap-y-12 px-4 pb-32">
          <div className="post flex flex-col gap-y-4">
            ...
            <div className="text-[#363636] font-bold text-2xl">Why you need a "Why" in design</div>
